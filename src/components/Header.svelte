...
<html lang="en">
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl" aria-hidden="true">
          <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[{base}/ff4694] to-[#776fff] opacity-20" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
              <a href="{base}/">Open roles <span aria-hidden="true">&rarr;</span></a>
              <a href="{base}/">Internship program <span aria-hidden="true">&rarr;</span></a>
              <a href="{base}/">Our values <span aria-hidden="true">&rarr;</span></a>
              <a href="{base}/">Meet our leadership <span aria-hidden="true">&rarr;</span></a>
            </div>
